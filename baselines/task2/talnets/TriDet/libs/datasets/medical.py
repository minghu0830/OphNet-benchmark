...
class MedicalDataset(Dataset):
    ...
    def _load_json_db(self, json_file):
        # load database and select the subset
        with open(json_file, 'r', encoding='gbk') as fid:
        ...
        for key, value in json_db.items():
            ...
            # if self.file_ext == '.pkl' and 'videomae' not in self.feat_extactor:
            #     feat_file = os.path.join(self.feat_folder,
            #                             self.file_prefix + key + '_' + self.feat_extactor + self.file_ext)
            # else:
            #     feat_file = os.path.join(self.feat_folder,
    ...
    def __getitem__(self, idx):
        ...
        #                             self.file_prefix + video_item['id'] + '_' + self.feat_extactor + self.file_ext)
        # else:
        #     filename = os.path.join(self.feat_folder,
