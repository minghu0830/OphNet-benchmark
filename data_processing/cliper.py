...
def main():
    excel_path = '/PATH/TO/OphNet2024_loca_challenge.csv or OphNet2024_loca_challenge_phase.csv'
    output_excel_path = '/PATH/TO/SAVE/OphNet2024_loca_challenge_trimmed.csv or OphNet2024_loca_challenge_phase_trimmed.csv' ##path to save new csv file with trimmed video name
    video_base_path = '/PATH/TO//OphNet_all_videos'
    output_base_path = '/PATH/TO/SAVE//OphNet2024_trimmed_operation or OphNet2024_trimmed_phase' #path to save trimmed videos
